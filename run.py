...
<<<<<<< HEAD
RANDOM_SEED = 42
PROCESORS = 2     						# number of procesors
CREATION_TIME_TWEET = [1, 5]        		# Create a tweet every [min, max] seconds
...
# event manager
>>>>>>> 1173acee16ad46e1cb7db3efcb7d7244af9edfdb
...
env.process(tweetPE.generator(env, procesors, CREATION_TIME_TWEET))
=======
